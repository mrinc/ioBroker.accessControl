...
vis.binds.iobrokeraccesscontrol = {
    ...
    showVersion: function () {
        if (vis.binds.iobrokeraccesscontrol.version) {
            ...
            vis.binds.iobrokeraccesscontrol.version = null;
        }
    },
	createWidget: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds.iobrokeraccesscontrol.createWidget(widgetID, view, data, style);
            }, 100);
        }
        ...
        if (data.oid) {
            vis.states.bind(data.oid + '.val', function (e, newVal, oldVal) {
                $div.find('.iobrokeraccesscontrol-value').html(newVal);
            });
        }
    }
};
	
vis.binds.iobrokeraccesscontrol.showVersion();
